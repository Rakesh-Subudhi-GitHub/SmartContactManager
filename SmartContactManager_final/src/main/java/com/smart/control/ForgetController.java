...
/*==========================================================================================================*/
	...
	public String openEmailFrom(Model model) {
		
		model.addAttribute("title","ForgetPassword");
	...
	public String verifyOtp(@RequestParam("userotp") int userotp, //catch the otp user entry
										HttpSession session,Model model) //Session otp send in previous method so collect that
	{
	...
	public String changePassword(@RequestParam("newPass") String newPassword,HttpSession session,Model model)
	{
	    ...
	    return "redirect:/signin?change=password changed successfully...";//redirect the page to login page
	}//method
